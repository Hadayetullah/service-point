  ...
  return (
    <section style={{background: "#F5F5F5"}}>
        <div className='container' style={{background:"#fff",padding:"20px"}}>
            <h1 style={{color:"#C71F66", textShadow:"-1px 2px 0px rgb(199, 31, 102)"}}>Our Privacy &#38; Policy</h1>
            <h6 style={{fontWeight:"bold"}}>
                This Terms of Use agreement was last updated: January 1st, 2023. This Privacy Policy agreement is effective as of: March 1st, 2022.
            </h6>
            <hr />
            <p>
            BD Service Platform Limited ("BD Service Point") values your privacy. In this Privacy Policy ("Policy"), we describe the information that we collect about you when you visit our website, www.bdservicepoint.com (the "Website") and use the services available on the Website ("Services"), and how we use and disclose that information.
            </p>
            <p>
            If you have any questions or comments about the Privacy Policy, please contact us at info@servicepointdhaka.com This Policy is incorporated into and is subject to the BD Service Point Terms of Use, which can be accessed at www.bdservicepoint.com /terms-and-condition. Your use of the Website and/or Services and any personal information you provide on the Website remains subject to the terms of the Policy and BD Service Point’sTerms of Use.
            </p>
            <h2>
            ...
            <p>
            We collect personal information from Service Professionals offering their products and services. This information is partially or completely accessible to all visitors using BD Service Point's website or mobile application, either directly or by submitting a request for a service. Service Professionals and customers are required to create an account to be able to access certain portions of our Website, such as to submit questions, participate in polls or surveys, to request a quote, to submit a bid in response to a quote, and request information. - Service Professionals, if and when they create and use an account with BD Service Point, will be required to disclose and provide to BD Service Point information including personal contact details, bank details, personal identification details and participate in polls or surveys or feedbacks etc. Such information gathered shall be utilized to ensure greater customer satisfaction and help a customer satiate their needs.
            </p>
            <p>
            ...
            <p>
            In order to request us for facebook data deletion please visit <strong>Facebook data deletion policy</strong>.
            </p>
            <h5>
            ...
            <p>
            We may obtain your device ID, which is sent to BD Service Point's servers and used in fraud prevention efforts.
            </p>
            <p>
            ...
            <h2>
            B. How BD Service Point Uses the Information We Collect
            </h2>
            <hr />
            <h5>
            ...
            <ul style={{listStyleType:"number"}}>
                ...
                <li>
                To process billing and payment, including sharing with third party payment gateways in connection with Website and/or BD Service Point's products and Services;
                </li>
                <li>
                ...
                <li>
                To periodically send promotional emails to the email address you provide regarding new products from BD Service Point, special offers from BD Service Point or other information about BD Service Point that we think you may find interesting;
                </li>
                <li>
                ...
                <li>
                For BD Service Point's market research purposes, including, but not limited to, the customization of the Website according to your interests;
                </li>
                <li>
                ...
                <li>
                From time to time, BD Service Point may use personal information for new and unanticipated uses not previously disclosed in our Privacy Policy. If our information practices change regarding information previously collected, BD Service Point shall make reasonable efforts to provide notice and obtain consent of any such uses as may be required by law.
                </li>
                <li>
                    For a better experience, while using our service, we may require you to provide us with certain personally identifiable information e.g. users name, address, location, phone number, device information. The information that We request will be retained by us and used as described in this privacy policy. The app does use third party services that may collect information used to identify you. Link to privacy policy of third party service providers used by the app:
                    <ul>
            ...
            <hr />
            <p>
            At our sole discretion, BD Service Point may offer any of the following free services on the Website, which you may select to use or receive at your option. Certain of the following services may require you to provide additional personal information as detailed below:
            </p>
            <h5>
            1. ELECTRONIC NEWSLETTERS
            </h5>
            <p>
            We may offer a free electronic newsletter to users. We will gather the email addresses of users who sign up for BD Service Point for the newsletter mailing list. Users may remove themselves from this mailing list by opting out of receiving newsletters during the registration process, by following the link provided in each newsletter that points users to a subscription management page where the user can unsubscribe from receiving newsletters or by changing their preferences in their Profile Settings page.
            </p>
            <h5>
            2."SEND TO A FRIEND"
            </h5>
            ...
            <p>
            In the event that BD Service Point undergoes a change in control, including, without limitation, a merger or sale of all or substantially all of BD Service Point's assets to which this Website relates or other corporate reorganization in which BD Service Point participates, and is thus merged with or acquired by a third party entity (a "Successor"), BD Service Point hereby reserves the right to transfer the information we have collected from the users of the Website and/or Services to such Successor.
            </p>
            <p>
            In addition, in the event of BD Service Point's bankruptcy, reorganization, receivership, or assignment for the benefit of creditors, or the application or laws or equitable principles affecting creditors' rights generally, BD Service Point may not be able to control how your information is transferred, used, or treated and reserves the right to transfer the information we have collected from the users of the Website and/or Services to non-affiliated third parties in such event.
            </p>
            <h5>
            7.INFORMATION DISCLOSED AT YOUR REQUEST
            </h5>
            <p>
            We may share your personal information with other Registered Users to whom you explicitly ask us to send your information or if you explicitly consent to such disclosure upon receipt of a specific Service. For instance, when you contract for a specific Service with another Registered User, BD Service Point will send that Registered User a notice that includes the personal information that you have chosen to allow BD Service Point to reveal to users with whom you contract.
            </p>
            <h2>
            ...
            <hr />
            <p>
            The Website may contain links to other websites or resources over which BD Service Point does not have any control. Such links do not constitute an endorsement by BD Service Point of those external websites. You acknowledge that BD Service Point is providing these links to you only as a convenience, and further agree that BD Service Point is not responsible for the content of such external websites. We are not responsible for the protection and privacy of any information which you provide while visiting such external websites and such sites are not governed by this Policy. Your use of any external website is subject to the terms of use and privacy policy located on the linked to external website.
            </p>
            <h2>
            ...
            <hr />
            <p>
            THIS POLICY IS CURRENT AS OF THE EFFECTIVE DATE SET FORTH ABOVE. BD Service Point MAY, IN ITS SOLE AND ABSOLUTE DISCRETION, CHANGE THIS POLICY FROM TIME TO TIME BY UPDATING THIS DOCUMENT. BD Service Point WILL POST ITS UPDATED POLICY ON THE WEBSITE ON THIS PAGE. BD Service Point ENCOURAGES YOU TO REVIEW THIS POLICY REGULARLY FOR ANY CHANGES. YOUR CONTINUED USE OF THIS WEBSITE AND/OR CONTINUED PROVISION OF PERSONAL INFORMATION TO US WILL BE SUBJECT TO THE TERMS OF THE THEN-CURRENT POLICY.
            </p>
            <p>
